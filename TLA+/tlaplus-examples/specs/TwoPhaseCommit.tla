...
Messages ==
  ...
  \* This is a union of two record types, yes TLA+ has record types. :)
...
TMRcvPrepared(r) ==
  ...
  (*************************************************************************)
  /\ tmState = "init" \* Enabling condition
  /\ [type |-> "Prepared", rm |-> r] \in msgs \* Another enabling condition
  /\ tmPrepared' = tmPrepared \cup {r}
  /\ UNCHANGED <<rmState, tmState, msgs>> \* The values in the new state are the same
